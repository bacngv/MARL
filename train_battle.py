...
if __name__ == '__main__':
    ...
    base_log_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f'results/tmp/{args.algo}_{opponent_type}')
    base_render_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f'results/render/{args.algo}_{opponent_type}')
    base_model_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f'results/models/{args.algo}_{opponent_type}')
    # main agent
